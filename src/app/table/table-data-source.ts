 ...
 */
export class DshTableDataSource<T> extends DataSource<T> {
    ...
    /**
     * Used by the DshTableComponent. Called when it connects to the data source.
     * @docs-private
     */
    connect() {
    ...
    /**
     * Used by the DshTableComponent. Called when it is destroyed. No-op.
     * @docs-private
     */
    disconnect() {}
}
