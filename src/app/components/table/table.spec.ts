...
import { DshTableDataSource } from './table-data-source';
...
describe('DshTable', () => {
    ...
    describe('with DshTableDataSource and sort/pagination/filter', () => {
        ...
        let dataSource: DshTableDataSource<TestData>;
    ...
    template: `
        <dsh-table [dataSource]="dataSource">
            <ng-container dshColumnDef="column_a">
                <dsh-header-cell *dshHeaderCellDef> Column A</dsh-header-cell>
                <dsh-cell *dshCellDef="let row"> {{ row.a }}</dsh-cell>
                <dsh-footer-cell *dshFooterCellDef> Footer A</dsh-footer-cell>
            </ng-container>

            <ng-container dshColumnDef="column_b">
                <dsh-header-cell *dshHeaderCellDef> Column B</dsh-header-cell>
                <dsh-cell *dshCellDef="let row"> {{ row.b }}</dsh-cell>
                <dsh-footer-cell *dshFooterCellDef> Footer B</dsh-footer-cell>
            </ng-container>

            <ng-container dshColumnDef="column_c">
                <dsh-header-cell *dshHeaderCellDef> Column C</dsh-header-cell>
                <dsh-cell *dshCellDef="let row"> {{ row.c }}</dsh-cell>
                <dsh-footer-cell *dshFooterCellDef> Footer C</dsh-footer-cell>
            </ng-container>

            <ng-container dshColumnDef="special_column">
                <dsh-cell *dshCellDef="let row"> fourth_row </dsh-cell>
            </ng-container>

            <dsh-header-row *dshHeaderRowDef="columnsToRender"></dsh-header-row>
            <dsh-row *dshRowDef="let row; columns: columnsToRender"></dsh-row>
            <dsh-row *dshRowDef="let row; columns: ['special_column']; when: isFourthRow"></dsh-row>
            <dsh-footer-row *dshFooterRowDef="columnsToRender"></dsh-footer-row>
        </dsh-table>
    `
})
...
@Component({
    template: `
        <table dsh-table [dataSource]="dataSource">
            <ng-container dshColumnDef="column_a">
                <th dsh-header-cell *dshHeaderCellDef>Column A</th>
                <td dsh-cell *dshCellDef="let row">{{ row.a }}</td>
            </ng-container>

            <ng-container dshColumnDef="column_b">
                <th dsh-header-cell *dshHeaderCellDef>Column B</th>
                <td dsh-cell *dshCellDef="let row">{{ row.b }}</td>
            </ng-container>

            <ng-container dshColumnDef="column_c">
                <th dsh-header-cell *dshHeaderCellDef>Column C</th>
                <td dsh-cell *dshCellDef="let row">{{ row.c }}</td>
            </ng-container>
...
@Component({
    template: `
        <table dsh-table [dataSource]="dataSource">
            ...
            <tr dsh-header-row *dshHeaderRowDef="columnsToRender; sticky: true"></tr>
            <tr dsh-row *dshRowDef="let row; columns: columnsToRender"></tr>
        </table>
    `
})
...
@Component({
    template: `
        <dsh-table [dataSource]="dataSource" [multiTemplateDataRows]="multiTemplateDataRows">
            ...
            <dsh-header-row *dshHeaderRowDef="['column_a']"></dsh-header-row>
            <dsh-row *dshRowDef="let row; columns: ['column_a']"></dsh-row>
            <dsh-row *dshRowDef="let row; columns: ['special_column']; when: isFourthRow"></dsh-row>
            <dsh-footer-row *dshFooterRowDef="['column_a']"></dsh-footer-row>
        </dsh-table>
    `
})
...
@Component({
    template: `
        <dsh-table [dataSource]="dataSource" matSort>
            <ng-container dshColumnDef="column_a">
                <dsh-header-cell *dshHeaderCellDef dsh-sort-header="a"> Column A</dsh-header-cell>
                <dsh-cell *dshCellDef="let row"> {{ row.a }}</dsh-cell>
                <dsh-footer-cell *dshFooterCellDef> Footer A</dsh-footer-cell>
            </ng-container>
        ...
        <dsh-paginator [pageSize]="5"></dsh-paginator>
    `
})
class ArrayDataSourceDshTableAppComponent implements AfterViewInit {
    underlyingDataSource = new FakeDataSource();
    dataSource = new DshTableDataSource<TestData>();
    columnsToRender = ['column_a', 'column_b', 'column_c'];
...
@Component({
    template: `
        <dsh-table [dataSource]="dataSource">
            ...
            <dsh-header-row *dshHeaderRowDef="columnsToRender"></dsh-header-row>
            <ng-container *dshRowDef="let row; columns: columnsToRender"> <dsh-row></dsh-row> </ng-container>
        </dsh-table>
    `
})
...
function getCells(row: Element): Element[] {
    ...
    let cells = getElements(row, 'dsh-cell');
    if (!cells.length) {
...
function getHeaderCells(headerRow: Element): Element[] {
    let cells = getElements(headerRow, 'dsh-header-cell');
    if (!cells.length) {
...
function getFooterCells(footerRow: Element): Element[] {
    let cells = getElements(footerRow, 'dsh-footer-cell');
    if (!cells.length) {
