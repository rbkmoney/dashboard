...
export class SearchFormComponent implements OnInit {
    ...
    localeBaseDir = 'sections.operations.invoices.filter';
    searchForm: FormGroup;
    expanded = false;
    statuses: InvoiceStatus.StatusEnum[] = ['unpaid', 'cancelled', 'paid', 'fulfilled'];
    paymentStatuses: PaymentStatus.StatusEnum[] = [
        'pending',
        'processed',
        'captured',
        'cancelled',
