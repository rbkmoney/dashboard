...
export class OrganizationDetailsComponent {
    organization$ = this.route.params.pipe(
        switchMap(({ orgId }) => this.organizationManagementService.getOrganization(orgId)),
        shareReplay(1)
    );
    ...
    constructor(private organizationManagementService: OrganizationManagementService, private route: ActivatedRoute) {}
