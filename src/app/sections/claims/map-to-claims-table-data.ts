...
const toClaimTableData = (
    { id, changeset, status, updatedAt }: Claim
): ClaimsTableData | null => ({
    claimID: id,
    changeset,
...
const claimsToTableData = (searchResult: Claim[]) =>
    searchResult.map(r => toClaimTableData(r));
